...
func registerSDKWords(r *eng.Registry, client *sdk.BenzokolonkaSDK) {
...
func runOp(client *sdk.BenzokolonkaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
