// Command Benzokolonka-cli is a CLI + REPL for the Benzokolonka SDK,
...
const prompt = "benzokolonka"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "fuel_price"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BENZOKOLONKA_APIKEY (api key), BENZOKOLONKA_BASE (base url override)")
