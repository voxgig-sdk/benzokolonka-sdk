...
Benzokolonka API client, generated from the OpenAPI spec.

This API provides access to price statistics for different fuel types across various regions in Russia, helping users track price changes over time.

Learn more about Benzokolonka API at [github.com/l0v3m0n3y/benzokolonka](https://github.com/l0v3m0n3y/benzokolonka).

This is an unofficial SDK for the Benzokolonka public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — FuelPrice — that you
...
const items = await client.FuelPrice().list({ fuel: "example" })
```
...
// fuelprices is an array of FuelPrice entities, populated with mock data
// — call fuelprices[0].data() for the record itself
...
```go
client := sdk.Test()
result, err := client.FuelPrice(nil).List(
    nil, nil,
)
```
...
| Python | `voxgig-sdk-benzokolonka-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/benzokolonka-sdk/tags) |
| PHP | `voxgig-sdk/benzokolonka-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/benzokolonka-sdk/tags) |
| Golang | `github.com/voxgig-sdk/benzokolonka-sdk/go` | `go get github.com/voxgig-sdk/benzokolonka-sdk/go@latest` |
| Ruby | `voxgig-sdk-benzokolonka-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/benzokolonka-sdk/tags) |
| Lua | `voxgig-sdk-benzokolonka-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/benzokolonka-sdk/tags) |
...
// List all fuelprices (returns FuelPriceEntity[] — .data() for the record)
...
```bash
cd go-mcp && go build -o benzokolonka-mcp .
```
...
```json
{
  "mcpServers": {
    "benzokolonka": {
      "command": "/abs/path/to/benzokolonka-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **FuelPrice** | The FuelPrice entity (list). | `/api/home` |
...
# List all fuelprices (returns a list, raises on error)
...
// List all fuelprices (returns an array; throws on error)
$fuelprices = $client->FuelPrice()->list();
print_r(array_map(fn($item) => $item->data_get(), $fuelprices));
```

### Golang

```go
import sdk "github.com/voxgig-sdk/benzokolonka-sdk/go"
...
# List all fuelprices (returns an Array; raises on error)
fuelprices = client.FuelPrice.list
puts fuelprices
```
...
- Upstream API: [https://github.com/l0v3m0n3y/benzokolonka](https://github.com/l0v3m0n3y/benzokolonka)
...
Generated from the Benzokolonka API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
