...
from benzokolonka_sdk.benzokolonka_types import (
    FuelPrice,
    FuelPriceListMatch,
)
...
class FuelPriceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FuelPriceEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[FuelPrice]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.FuelPrice().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
