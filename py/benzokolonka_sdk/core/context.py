...
from benzokolonka_sdk.core.control import BenzokolonkaControl
...
from benzokolonka_sdk.core.helpers import get_ctx_prop, to_map
...
class BenzokolonkaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BenzokolonkaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BenzokolonkaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BenzokolonkaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BenzokolonkaError(code, msg, self)
