# Benzokolonka Python SDK



The Python SDK for the Benzokolonka API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.FuelPrice()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/benzokolonka-sdk/releases)) or
...
client = BenzokolonkaSDK(options)
```
...
```
py/
├── benzokolonka_sdk.py         -- Main SDK module
