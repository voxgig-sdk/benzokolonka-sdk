# Benzokolonka SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BenzokolonkaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BenzokolonkaSDK(...) and BenzokolonkaSDK.test(...) become
#      BenzokolonkaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "benzokolonka_sdk"
_SDK_CLASS = "BenzokolonkaSDK"
