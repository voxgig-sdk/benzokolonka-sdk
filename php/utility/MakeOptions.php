...
// Benzokolonka SDK utility: make_options

class BenzokolonkaMakeOptions
{
    ...
    public static function call(BenzokolonkaContext $ctx): array
    {
        ...
        //
        // `BenzokolonkaSchema::optspec()` is built from the model:
        ...
        $optspec = BenzokolonkaSchema::optspec();
