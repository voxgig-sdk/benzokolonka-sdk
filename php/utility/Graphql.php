...
// Benzokolonka SDK utility: graphql
//
...
class BenzokolonkaGraphql
{
    ...
    // equivalent.
    public static function body(BenzokolonkaContext $ctx): mixed
    {
    ...
    public static function errors(BenzokolonkaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
