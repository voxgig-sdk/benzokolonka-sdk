...
// Benzokolonka SDK streaming feature
...
class BenzokolonkaStreamingFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _iterate(BenzokolonkaResult $result): \Generator
    {
    ...
    private function _streamable(BenzokolonkaContext $ctx): bool
    {
