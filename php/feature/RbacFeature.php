...
class BenzokolonkaRbacFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _required(BenzokolonkaContext $ctx): ?string
    {
    ...
    private function _reject(BenzokolonkaContext $ctx, string $required): void
    {
    ...
    private function _track(BenzokolonkaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
