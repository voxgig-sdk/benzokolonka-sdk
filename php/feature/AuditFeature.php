...
// Benzokolonka SDK audit feature
...
class BenzokolonkaAuditFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _emit(BenzokolonkaContext $ctx, string $outcome): void
    {
