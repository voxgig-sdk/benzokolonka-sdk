...
// Benzokolonka SDK idempotency feature
...
class BenzokolonkaIdempotencyFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _mutating(BenzokolonkaContext $ctx): bool
    {
