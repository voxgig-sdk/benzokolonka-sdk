...
// Benzokolonka SDK netsim feature
...
class BenzokolonkaNetsimFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _simulate(BenzokolonkaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BenzokolonkaContext $ctx, array $applied): void
    {
        $client = $this->client;
