...
// Benzokolonka SDK proxy feature
...
class BenzokolonkaProxyFeature extends BenzokolonkaBaseFeature
{
    ...
    public function init(BenzokolonkaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BenzokolonkaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
