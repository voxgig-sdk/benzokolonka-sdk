...
// Benzokolonka SDK telemetry feature
...
class BenzokolonkaTelemetryFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _close(BenzokolonkaContext $ctx, bool $ok): void
    {
