...
// Benzokolonka SDK clienttrack feature
...
class BenzokolonkaClienttrackFeature extends BenzokolonkaBaseFeature
{
    ...
    public function PostConstruct(BenzokolonkaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Benzokolonka-SDK';
