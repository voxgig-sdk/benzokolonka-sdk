...
// Benzokolonka SDK timeout feature
...
class BenzokolonkaTimeoutFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _with_timeout(BenzokolonkaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BenzokolonkaContext $_ctx, float $ms): void
    {
        $client = $this->client;
