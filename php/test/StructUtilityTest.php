...
// Benzokolonka SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BenzokolonkaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BenzokolonkaOmni::structfix($now, Struct::undef()))
                        !== json_encode(BenzokolonkaOmni::structfix($val, Struct::undef()))) {
