...
class BenzokolonkaTestRunner
{
    ...
    {
        $live = self::getenv('BENZOKOLONKA_TEST_LIVE');
        $override = self::getenv('BENZOKOLONKA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BENZOKOLONKA_TEST_EXPLAIN');
...
class_alias('BenzokolonkaTestRunner', 'Runner');
class_alias('BenzokolonkaHelpers', 'Helpers');
