...
// Benzokolonka SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BenzokolonkaSDK::test)
...
{
    private const SDK_CLASS = 'BenzokolonkaSDK';
    ...
    private const SDK_BASE = 'benzokolonka_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../benzokolonka_sdk.php';
