...
module BenzokolonkaTestRunner
  ...
  def self.env_override(m)
    live = getenv("BENZOKOLONKA_TEST_LIVE")
    override = getenv("BENZOKOLONKA_TEST_OVERRIDE")
    ...
    explain = getenv("BENZOKOLONKA_TEST_EXPLAIN")
    m["BENZOKOLONKA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BenzokolonkaTestRunner
Helpers = BenzokolonkaHelpers
Vs = VoxgigStruct
