...
#      offline in seeded test mode (BenzokolonkaSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Benzokolonka_sdk.rb")
  SDK_CLASS = "BenzokolonkaSDK"
