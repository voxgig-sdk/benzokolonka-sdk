...
class FuelPriceEntity extends BenzokolonkaEntityBase_1.BenzokolonkaEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'fuel_price';
        this.name_ = 'fuel_price';
        this.Name = 'FuelPrice';
    }
    make() {
        return new FuelPriceEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<FuelPrice[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.FuelPriceEntity = FuelPriceEntity;
//# sourceMappingURL=FuelPriceEntity.js.map