...
(0, node_test_1.describe)('FuelPriceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BenzokolonkaSDK({
    ...
    (0, node_test_1.test)('direct-list-fuel_price', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-fuel_price', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BENZOKOLONKA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BenzokolonkaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BENZOKOLONKA_TEST_FUEL_PRICE_ENTID'];
    ...
    const client = new __1.BenzokolonkaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FuelPriceDirect.test.js.map