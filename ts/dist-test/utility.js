...
function envOverride(m) {
    if ('TRUE' === process.env.BENZOKOLONKA_TEST_LIVE ||
        'TRUE' === process.env.BENZOKOLONKA_TEST_OVERRIDE) {
    ...
    m.BENZOKOLONKA_TEST_EXPLAIN = process.env.BENZOKOLONKA_TEST_EXPLAIN || m.BENZOKOLONKA_TEST_EXPLAIN;
    return m;
}
