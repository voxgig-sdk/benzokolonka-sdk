...
class BenzokolonkaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BenzokolonkaSDK/1.0)';
    ...
    public static function call(BenzokolonkaContext $ctx, string $fullurl, array $fetchdef): array
    {
