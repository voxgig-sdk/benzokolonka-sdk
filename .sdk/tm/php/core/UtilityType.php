...
// Benzokolonka SDK utility type

class BenzokolonkaUtility
{
    ...
    public static function copy(BenzokolonkaUtility $src): BenzokolonkaUtility
    {
        $u = new BenzokolonkaUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
