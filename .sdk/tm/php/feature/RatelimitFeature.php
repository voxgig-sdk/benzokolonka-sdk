...
// Benzokolonka SDK ratelimit feature
...
class BenzokolonkaRatelimitFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _acquire(BenzokolonkaContext $ctx): void
    {
    ...
    private function _track(BenzokolonkaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
