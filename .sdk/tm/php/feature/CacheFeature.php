...
// Benzokolonka SDK cache feature
...
class BenzokolonkaCacheFeature extends BenzokolonkaBaseFeature
{
    ...
    private function _through(BenzokolonkaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
