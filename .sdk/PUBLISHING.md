...
|---|---|---|
| `ts/` | @voxgig-sdk/benzokolonka-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/benzokolonka-sdk \
      --repository voxgig-sdk/benzokolonka-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/benzokolonka-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/benzokolonka-sdk --id=<id>` removes one.
