...
function runner.env_override(m)
  local live = runner.getenv("BENZOKOLONKA_TEST_LIVE")
  local override = runner.getenv("BENZOKOLONKA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BENZOKOLONKA_TEST_EXPLAIN")
