...
describe("FuelPriceDirect", function()
  it("should direct-list-fuel_price", function()
    local setup = fuel_price_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-fuel_price", setup.live and "live" or "unit")
...
function fuel_price_direct_setup(mockres)
