// Command Benzokolonka-mcp is an MCP server exposing the Benzokolonka
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Benzokolonka_list  — list records of an entity
//	Benzokolonka_load  — load a single record of an entity
//
